...
// class _FinancialReportScreenState extends State<FinancialReportScreen> with TickerProviderStateMixin {
...
//         );
//       } else {
//         // Reset to first page after final screen
...
//             onTap: () {
//               // Pause auto-scroll when user taps
//               _stopAutoScroll();
...
//               onPressed: () {
//                 Navigator.of(context).pop();
//                 context.push('/analytics'); // Navigate to detailed reports
//               },
